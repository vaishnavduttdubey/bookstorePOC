...
class ArrowDownRightIcon extends BaseIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.4", ngImport: i0, type: ArrowDownRightIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.4", type: ArrowDownRightIcon, isStandalone: true, selector: "[data-p-icon=\"arrow-down-right\"]", usesInheritance: true, ngImport: i0, template: `
        <svg:path
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.4", ngImport: i0, type: ArrowDownRightIcon, decorators: [{
            type: Component,
            args: [{

...
declare class OverlayStyle extends BaseStyle {
    ...
    classes: {
        ...
        root: ({ instance }: {
            ...
            'p-overlay-modal p-overlay-mask p-overlay-mask-enter': any;
